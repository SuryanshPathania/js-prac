...
// console.log(allhero);// mergees 2 arrays properly

const all_new_heroes = [...marvelheros,...dc]// in JavaScript is known as the spread operator. it is used to combine two arrays (marvelheros and dc) into a single array (all_new_heroes).
console.log(all_new_heroes);

const another_array = [1,2,3,[4,5,6],7,[9,[4,5]]]
const real_another_array = another_array.flat(Infinity)//()-depth ke liye hota agar infinity kardo to apne aap dekh leta
